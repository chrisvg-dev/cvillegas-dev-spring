...
public class CoursesController {
    ...
    public ResponseEntity<CoursesWrapper> findAll(HttpServletRequest httpServletRequest,
            HttpServletResponse httpServletResponse, Map<String, String> pathVariables) {
    ...
    @PostMapping(value = "/putCertificate", consumes = { MediaType.APPLICATION_JSON_VALUE,
            MediaType.MULTIPART_FORM_DATA_VALUE })
    public ResponseEntity<Object> saveCourse(@RequestPart("course") CourseRequestDto course,
        ...
        if (Objects.isNull(courseSaved)) {
            basicResponseDto = new BasicResponseDto(HttpStatus.BAD_REQUEST,
                    "There was an error. The records could not br saved.");
        } else {
